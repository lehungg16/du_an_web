...
<html lang="vi">
<div class="container">
    <h2 class="title">Quản lý tài khoản Người</h2>
<div class="top-bar">
    <input type="text" placeholder=" 🔍 Tìm tên đăng nhập..." class="search"><button>Tìm</button>

    <a href="actions/add_user.php"> Thêm tài khoản</a>
</div>
        ...
        <tr>
            <form method="post">
                ...
                <td>
                    ...
                    <button name="view"> Xem Chi Tiêt</button>
